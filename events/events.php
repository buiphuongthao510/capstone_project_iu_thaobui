            ...
            success: function (data) {
                ...
                $.each(data, function(i, n){
                    if (n.nevent_name==null || n.nevent_name==""){
                        ...
                        $(".content").prepend('<br><a href="https://cgi.luddy.indiana.edu/~team21/includes/search_info_events.php?o_id='+n.o_id+'" style="color: #FFFFFF;"><event></event> event name: '+n.nevent_name+'</a><br><br>')
