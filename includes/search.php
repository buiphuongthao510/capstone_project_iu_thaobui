            ...
            success: function (data) {
                ...
                $.each(data, function(i, n){
                    if (n.nevent_name==null || n.nevent_name==""){
                        $(".content").prepend('<a href="https://cgi.luddy.indiana.edu/~team21/includes/search_info.php?o_id='+n.o_id+'" style="color: #FFFFFF;"> name: '+n.name+'</ a><br><br>')

                    }else{
                        $(".content").prepend('<br><a href="https://cgi.luddy.indiana.edu/~team21/includes/search_info.php?o_id='+n.o_id+'" style="color: #FFFFFF;"> nevent name: '+n.nevent_name+'</ a><br><br>')
