...
<body>
	...
	// Insert Query 
		$sql = "INSERT INTO events(event_name,event_date,event_time,address,description,image, username, o_id) VALUES ('".$event_name."','".$event_date."','".$event_time."','".$address."','".$description."','".$path."','".$cas_username."',''test);";
