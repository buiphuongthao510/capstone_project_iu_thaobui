...
<body>
	...
	// Insert Query 
		...
		$update_sql = "UPDATE events SET events.o_id = (SELECT organizations.o_id FROM organizations WHERE organizations.m_username = events.username OR events.username = null);";
