    ...
    function search() {
        ...
        $.ajax({
            ...
            $.each(data, function(i, n){
               if(n.event_name !== ''){
                        $(".content").prepend('<br><a href="https://cgi.luddy.indiana.edu/~team21/includes/search_info.php?o_id='+n.o_id+'" style="color: #FFFFFF;"> event name: '+n.nevent_nameame+'</a><br><br>');
